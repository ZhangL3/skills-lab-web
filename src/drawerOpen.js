...
export default AFRAME.registerComponent('drawer_open',{
    ...
    init: function (){
        ...
        // const twoCabinet = document.querySelector("#twoCabinet");

        this.el.addEventListener('click', () => {
            // twoCabinet.components.sound.playSound();
        });

        // Add open and close animation of drawer
        aAnimationWrapper(this.el, 'click', 'position', close, open, dur, 'alternate');
